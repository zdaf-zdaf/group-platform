# Generated by Django 5.2.1 on 2025-09-01 06:57
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('pdf', 'PDF文档'), ('video', '视频教程'), ('doc', '文档资料'), ('image', '图表素材'), ('code', '代码示例'), ('slide', '幻灯片')], max_length=10, verbose_name='资料类型')),
                ...
                ('question_set', models.IntegerField(blank=True, null=True, verbose_name='关联题组ID')),
            ],
            options={
                'verbose_name': '学习资料',
